        ...
        <div className="container-501">
          {result?.map((item) => {
            ...
            if (item?.type!="breakfasts")
              return (
                <Link key={item?._id} href={'/' + (item?.type||"competitions") + '/' + item?._id}>
                  <div
                    ...
                    <div className="blog-content">
                      ...
                      <div className="profile-block">
                        <div className="normal-wrapper">
                          <div className="font-bold mb-2 rounded capitalize bg-yellow-200 text-yellow-800 py-1 px-4">{item?.type || "competitions"}</div>
                          <p className="paragraph-detials-small">{finaldate}</p>
                        </div>
                      </div>
                    </div>
                  </div>
